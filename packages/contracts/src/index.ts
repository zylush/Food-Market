...
export const ErrorCode = {
  ...
  SubscriptionCancellationUnavailable: "SUBSCRIPTION_CANCELLATION_UNAVAILABLE",
...
export const API_ERROR_MESSAGE_KEYS: Record<ErrorCodeValue, string> = {
  ...
  SUBSCRIPTION_CANCELLATION_UNAVAILABLE: "errors.subscriptionCancellationUnavailable",
